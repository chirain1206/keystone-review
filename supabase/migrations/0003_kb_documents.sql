...
revoke all on function public.match_kb_documents(vector, text, text, text, text, int) from anon, authenticated;

-- 余弦相似度检索：按 class/spec/dungeon/patch 过滤，top-k 由 match_count 控制。
